...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (userConfig.iconset === 'default') {
            ...
            await interaction.reply({ content: "You have changed your iconset into **Sapphirazurite's Alternative Icons**!\n\nIcons by [Sapphirazurite](<https://youtube.com/@sapphirazurite>)", ephemeral: true });
        }
        else if (userConfig.iconset === 'saph') {
            userConfig.iconset = 'default';
            await interaction.reply({ content: "You have changed your iconset into **TUF Default Icons**!\n\n[Icons by the Universal Forums](<https://github.com/t21c/t21c-assets>), available under [the CC BY 4.0 license](<http://creativecommons.org/licenses/by/4.0/>)", ephemeral: true });
        }
